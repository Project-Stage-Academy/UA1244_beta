...
const Register = () => {
  ...
  const [successMessage, setSuccessMessage] = useState(''); // Додаємо змінну для повідомлення про успіх
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage(`Registration successful! A confirmation email has been sent to ${email}. Please confirm your account.`);
  ...
  return (
    <div className="container">
      ...
      {successMessage && <p className="alert alert-success">{successMessage}</p>} {/* Повідомлення про успіх */}
