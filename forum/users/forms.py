...
class UserLoginForm(AuthenticationForm):
    ...
    It customizes the username and password fields to enhance user experience with placeholders and additional HTML attributes.
    """
...
class RoleSelectionForm(forms.Form):
    ...
    If no roles are available, the dropdown is disabled and a help text message is displayed to notify the user.
    """
